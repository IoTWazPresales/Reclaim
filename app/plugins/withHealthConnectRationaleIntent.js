...
class PermissionsRationaleActivity : Activity() {
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    AlertDialog.Builder(this)
      ...
      .setMessage("Reclaim uses Health Connect to read the health data you choose (for example sleep, heart rate during sleep, and related overnight vitals you approve). You can grant or manage these permissions in the next screen.")
