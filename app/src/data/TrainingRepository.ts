...
import {
  ...
  getTrainingSessionItemById as apiGetTrainingSessionItemById,
...
export async function getTrainingSessionItemById(itemId: string): Promise<TrainingSessionItemRow | null> {
  logger.debug('[TRAINING_READ] getTrainingSessionItemById', { itemId });
  return apiGetTrainingSessionItemById(itemId);
}
