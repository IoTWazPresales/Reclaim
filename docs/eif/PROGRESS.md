...
| N-0056 | AVD dev-client recovery | blocked after post-uninstall reinstall: project socket timeout; native-client mismatch suspected | — | baseline/N0056_RETRY.md; local reinstall-launch.png/xml | operator direction; fresh native debug build is next distinct action |
