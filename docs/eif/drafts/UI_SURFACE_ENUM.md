# UI Surface Enumeration — Reclaim (AS-IS)

**Recorded:** 2026-09-19  
**Repo:** `C:\Reclaim`  
**Branch context:** product UI under `app/`  
**Evidence class:** source read only (navigators, screens, overlays, theme tokens).  
**Visual scores:** **UNABLE_TO_VERIFY** on every surface until adb / device screenshots exist.  
