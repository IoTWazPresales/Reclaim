...
| N-0057 | observation | R1 | N-0051 | Assess remaining public moddatetime extension warning and dependencies; propose safe relocation/retention without silently altering triggers. Schedule with security follow-up / final human checks. |
| N-0058 | feature | R2 | N-0046 | Combined Stage 1 review: bind account deletion to confirmed identity/token; prevent account-switch and cleanup races; compare response identity; deterministic race tests. Release blocker, schedule next before wave 2. |
...
| N-0063 | feature | R2 | N-0001 | Close confirmed live anonymous app_logs SELECT exposure and unsafe repository recipe; acceptance/N-0063.txt. Additional live migration requires AGENTS section 8 approval. |
