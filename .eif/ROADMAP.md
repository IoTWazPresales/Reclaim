...
- N-0014 **C-N account-delete completeness** `proposed`/`proposed` (feature)
...
- N-0030 **C-D implement chosen UI direction** `blocked`/`blocked` (redesign)
- N-0031 **C-F operator-picked features** `blocked`/`blocked` (feature)
